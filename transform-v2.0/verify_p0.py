...
with sync_playwright() as p:
    ...
    check('首页-v1.1 单层双入口', '想清楚' in body and '做得到' in body and '每日洞察' in body and '每日改变' in body)
    check('首页-双入口链接(HTML)', 'href="think.html"' in html and 'href="punch.html"' in html and '每日洞察' in body and '每日改变' in body)
